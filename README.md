...
*(A simple analogy is that of C and Rust, C gives you more control and freedom and but that is not safe, however Rust gives more constraints and rules and is more safe.)*
